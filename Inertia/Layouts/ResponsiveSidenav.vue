        ...
        <div class="min-h-screen bg-white relative flex">
            ...
            <div class="sidebar bg-blue-50 w-64 space-y-6 px-2 absolute md:relative inset-y-0 left-0 transform -translate-x-full md:translate-x-0 transition duration-200 ease-in-out">
                ...
                <nav>
                    ...
                    <inertia-link :href="'#'" class="block py-2.5 px-4 hover:bg-blue-100 text-gray-800 transition duration:100 rounded-lg" :class="route().current('products') ? 'border-r-8 border-blue-700 bg-blue-100 text-blue-700' : ''">
                        ...
                        <div class="flex justify-between h-16">
                            <div class="flex">
                                ...
                                <div class="hidden space-x-8 sm:-my-px sm:flex items-center">
                                    ...
                                    <!-- <jet-nav-link :href="'#'" :active="route().current('products')">
                                        Products
                                    </jet-nav-link> -->
                                    <inertia-link :href="'#'" class="text-xs text-blue-700 border border-blue-700 rounded-lg px-4 py-2 hover:bg-blue-700 hover:text-white font-black transition duration-100">
